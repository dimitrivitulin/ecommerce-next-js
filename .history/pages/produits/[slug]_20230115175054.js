        ...
        <Container>
          <div className="flex pt-8 min-h-fit lg:px-40">
            ...
            <div className=" w-1/2 flex flex-col gap-5">
              ...
              <button className="snipcart-add-item w-36 inline-block rounded-md border border-transparent bg-stone-500 py-3 px-8 text-center font-medium text-white shadow-md hover:bg-stone-600 hover:shadow-xl" 
